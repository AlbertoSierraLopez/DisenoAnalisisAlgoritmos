def subcolecciones_principal(coleccion, n, m):
    soluciones = [0] * n
    s = [0]
    subcolecciones(0, coleccion, n, m, 0, soluciones, s)
    print(s[0])
...
def subcolecciones(i, coleccion, n, m, ns, soluciones, s):
    ...
    if ns == m or i == n:
        ...
        for k in range(0, 2):
            ...
            if k == 0:
                subcolecciones(i + 1, coleccion, n, m, ns, soluciones, s)
            else:
                subcolecciones(i + 1, coleccion, n, m, ns + 1, soluciones, s)
